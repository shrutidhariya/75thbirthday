...
$(document).ready(function()
{
	...
	*/
	...
	function jokesload(){
		var quotes = [
			["Mai Parshva se LED bulb kyu nahi le sakta? Kyuki SYS ka LED hai", "Nippy"],
			["Dairymilk ke detective ko kya bolenge? GEMS Bond", "Saap"],
			["If I changed the language settings for Siri to Tamil and say, 'Hey Siri', will she start laughing", "IT"],
			["Kaisa hai tu, Tic Tac", "Nipun"],
			["Phone uparse giraya but woh tuta nahi, aise kyu? Kyuki phone flight mode pe tha","Nipun Iyer"]
		  ];
		  
		  var lastNum;
		  var randomNum;
		  var thisQuote = "Life shrinks or expands in proportion to one’s courage.";
		  var thisAuthor = "Nipun Iyer";
		  var curr = 0;
		  ...
		  $(document).ready(function() {
			$("#newQuote").click(function() {
				$("#quote").text(quotes[curr%quotes.length][0]);
				$("#author").text(quotes[curr%quotes.length][1]);
				curr++;
			});
			$(".btn").hover(function() {
